...
?>
    ...
    <body>
        ...
        <header>
            ...
            <?php
            include 'content/1_Header__contacts.php';
            // include 'content/2_Header-info__about.php';
        ...
        <main>
            <?php
            // include 'content/3_Our-Services.php';
            // include 'content/4_Services.php';
            // include 'content/5_Why_Larnaka.php';
        ...
        <footer>
            <?php
            include 'content/8_Footer__contacts.php';
